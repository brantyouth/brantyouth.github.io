...
!function(){for(var n=document.links,o=0,t=n.length;o<t;o++)n[o].hostname!=window.location.hostname&&(n[o].target="_self")}();
...
!function(o,e,a){o("#menu").click(function(){o("body").addClass("push-menu-to-right"),o("#sidebar").addClass("open"),o(".overlay").addClass("show")}),o("#mask").click(function(){o("body").removeClass("push-menu-to-right"),o("#sidebar").removeClass("open"),o(".overlay").removeClass("show")});var s=o(".modal .close");s.on("click",function(){s.parent().parent().addClass("closed")});var c=o(".modal.exit");c.length&&ouibounce(c[0],{aggressive:!0,callback:function(){c.find(".close").on("click",function(){c.hide()})}});var n={close:o(".icon-remove-sign"),searchform:o(".search-form"),canvas:o("body"),dothis:o(".dosearch")};function r(){o(".search-wrapper").toggleClass("active"),n.searchform.toggleClass("active"),n.canvas.removeClass("search-overlay")}n.dothis.on("click",function(){o(".search-wrapper").toggleClass("active"),n.searchform.toggleClass("active"),n.searchform.find("input").focus(),n.canvas.toggleClass("search-overlay"),o(".search-field").simpleJekyllSearch()}),n.close.on("click",r),document.addEventListener("keyup",function(e){27==e.keyCode&&o(".search-overlay").length&&r()}),1<=document.getElementsByClassName("home").length&&new AnimOnScroll(document.getElementById("grid"),{minDuration:.4,maxDuration:.7,viewportFactor:.2}),smoothScroll.init({selectorHeader:".bar-header",speed:500,updateURL:!1})}(Zepto,window);
